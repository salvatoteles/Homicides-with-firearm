#Estimation of november 2020 and 21 for the outofsample exercise for LSTM.
...
indica <- indica0[min(which(indica0$X1 != 9.999900e+04)):max(which(indica0$Hom != 9.999900e+04)),]
...
indica <- indica0[min(which(indica0$X1 != 9.999900e+04)):max(which(indica0$Hom != 9.999900e+04)),]
indica <- data.frame(indica[,2:ncol(indica)])
indica <- subset(indica, select = -c(Hom1))
...
indica <- indica0[min(which(indica0$X1 != 9.999900e+04)):max(which(indica0$Hom != 9.999900e+04)),]
indica <- data.frame(indica[,2:ncol(indica)])
indica <- subset(indica, select = -c(Hom1,Hom2))
...
indica <- indica0[min(which(indica0$X1 != 9.999900e+04)):max(which(indica0$Hom != 9.999900e+04)),]
indica <- data.frame(indica[,2:ncol(indica)])
indica <- subset(indica, select = -c(Hom1,Hom2,Hom3))
...
indica <- indica0[min(which(indica0$X1 != 9.999900e+04)):max(which(indica0$Hom != 9.999900e+04)),]
indica <- data.frame(indica[,2:ncol(indica)])
indica <- subset(indica, select = -c(Hom1,Hom2,Hom3,Hom4))
...
indica <- indica0[min(which(indica0$X1 != 9.999900e+04)):max(which(indica0$Hom != 9.999900e+04)),]
indica <- data.frame(indica[,2:ncol(indica)])
indica <- subset(indica, select = -c(X1,Hom1,Hom2,Hom3,Hom4))
...
indica <- data.frame(indica[,2:ncol(indica)])
indica <- subset(indica, select = -c(X1,Hom1,Hom2,Hom3,Hom4,X1,GA,MOH,H3,GTH,BCs,GTG,MOR,EPU,MOU,TW,
                                     GA1,MOH1,H31,GTH1,BCs1,GTG1,MOR1,EPU1,MOU1,TW1))
...
indica <- indica0[min(which(indica0$X1 != 9.999900e+04)):(max(which(indica0$Hom != 9.999900e+04))+1),]
...
indica <- indica0[min(which(indica0$X1 != 9.999900e+04)):(max(which(indica0$Hom != 9.999900e+04))+2),]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast[1]
...
indica <- indica0[min(which(indica0$X1 != 9.999900e+04)):(max(which(indica0$Hom != 9.999900e+04))+3),]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast[1]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast_v0[1]
...
indica <- indica0[min(which(indica0$X1 != 9.999900e+04)):(max(which(indica0$Hom != 9.999900e+04))+4),]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast[1]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast_v0[1]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast_v1[1]
...
#######################From sixth to 11th forecast with the fifth network quarterly 
for (j in 5:12){
  indica <- indica0[min(which(indica0$X1 != 9.999900e+04)):(max(which(indica0$Hom != 9.999900e+04))+j),]
  indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast[1]
  indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast_v0[1]
  for (k in 1:(j-2)){
  ...
  #lstm_forecast_v3 <- lstm_model_v3 %>% predict(x_pred_arr, batch_size = 1) %>% .[, , 1]
  valor <- lstm_model_v4t %>% predict(x_pred_arr, batch_size = 1) %>% .[, , 1]
  nam <- paste0("lstm_forecast_v",j-1)
  assign(nam, valor[1] * sd(indica[,"Hom"]) + mean(indica[,"Hom"]))
  #lstm_forecast_v3 <- lstm_forecast_v3 * sd(indica[,"Hom"]) + mean(indica[,"Hom"])
  
}
#######################From 11th to 24th, orecast with the fifth network non quarterly 
for (j in 13:23){
indica <- indica0[min(which(indica0$X1 != 9.999900e+04)):(max(which(indica0$Hom != 9.999900e+04))+j),]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast[1]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast_v0[1]
