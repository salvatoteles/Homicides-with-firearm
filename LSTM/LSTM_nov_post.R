#Estimation of november 2017,18 and 19 for the outofsample exercise for LSTM.
...
indica <- indica0[min(which(indica0$GA4 != 9.999900e+04)):max(which(indica0$Hom != 9.999900e+04)),]
indica <- data.frame(indica[,2:ncol(indica)])
indica <- subset(indica,select=-c(X1))
...
indica <- indica0[min(which(indica0$GA4 != 9.999900e+04)):max(which(indica0$Hom != 9.999900e+04)),]
indica <- data.frame(indica[,2:ncol(indica)])
indica <- subset(indica, select = -c(Hom1,X1))
...
indica <- indica0[min(which(indica0$GA4 != 9.999900e+04)):max(which(indica0$Hom != 9.999900e+04)),]
indica <- data.frame(indica[,2:ncol(indica)])
indica <- subset(indica, select = -c(Hom1,Hom2,X1))
...
indica <- indica0[min(which(indica0$GA4 != 9.999900e+04)):max(which(indica0$Hom != 9.999900e+04)),]
indica <- data.frame(indica[,2:ncol(indica)])
indica <- subset(indica, select = -c(Hom1,Hom2,Hom3,X1))
...
indica <- indica0[min(which(indica0$GA4 != 9.999900e+04)):max(which(indica0$Hom != 9.999900e+04)),]
indica <- data.frame(indica[,2:ncol(indica)])
indica <- subset(indica, select = -c(Hom1,Hom2,Hom3,Hom4,X1))
...
indica <- indica0[min(which(indica0$GA4 != 9.999900e+04)):max(which(indica0$Hom != 9.999900e+04)),]
indica <- data.frame(indica[,2:ncol(indica)])
indica <- subset(indica, select = -c(X1,Hom1,Hom2,Hom3,Hom4,X1))
...
indica <- indica0[min(which(indica0$GA4 != 9.999900e+04)):(max(which(indica0$Hom != 9.999900e+04))+1),]
...
indica <- indica0[min(which(indica0$GA4 != 9.999900e+04)):(max(which(indica0$Hom != 9.999900e+04))+2),]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast[1]
...
indica <- indica0[min(which(indica0$GA4 != 9.999900e+04)):(max(which(indica0$Hom != 9.999900e+04))+3),]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast[1]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast_v0[1]
...
indica <- indica0[min(which(indica0$GA4 != 9.999900e+04)):(max(which(indica0$Hom != 9.999900e+04))+4),]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast[1]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast_v0[1]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast_v1[1]
...
for (j in 5:23){
indica <- indica0[min(which(indica0$GA4 != 9.999900e+04)):(max(which(indica0$Hom != 9.999900e+04))+j),]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast[1]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast_v0[1]
for (k in 1:(j-2)){
