...
w <- c(1109,1110,1111,1112) #por el de cities
#w <- c(1113,1114,1115,1116)  #Por el de twitter
#w <- c(1117,1118,1119) #por el GA
#w <- c(1120,1121)
#momento <- c(1221)

for(momento in w){
  indica0<-read_xlsx(paste0("datos_Monthly_Homicides_",momento,".xlsx"),sheet="Sheet1",col_names = TRUE) 
...
indica <- indica0[min(which(indica0$H34 != 9.999900e+04)):max(which(indica0$Hom != 9.999900e+04)),]
indica <- data.frame(indica[,2:ncol(indica)])
indica <- subset(indica,select=-c(X1,GA,GA1,GA2,GA3,GA4,TW,TW1,TW2,TW3,TW4))
...
indica <- indica0[min(which(indica0$H34 != 9.999900e+04)):max(which(indica0$Hom != 9.999900e+04)),]
indica <- data.frame(indica[,2:ncol(indica)])
indica <- subset(indica, select = -c(Hom1,X1,GA,GA1,GA2,GA3,GA4,TW,TW1,TW2,TW3,TW4))
...
indica <- indica0[min(which(indica0$H34 != 9.999900e+04)):max(which(indica0$Hom != 9.999900e+04)),]
indica <- data.frame(indica[,2:ncol(indica)])
indica <- subset(indica, select = -c(Hom1,Hom2,X1,GA,GA1,GA2,GA3,GA4,TW,TW1,TW2,TW3,TW4))
...
indica <- indica0[min(which(indica0$H34 != 9.999900e+04)):max(which(indica0$Hom != 9.999900e+04)),]
indica <- data.frame(indica[,2:ncol(indica)])
indica <- subset(indica, select = -c(Hom1,Hom2,Hom3,X1,GA,GA1,GA2,GA3,GA4,TW,TW1,TW2,TW3,TW4))
...
indica <- indica0[min(which(indica0$H34 != 9.999900e+04)):max(which(indica0$Hom != 9.999900e+04)),]
indica <- data.frame(indica[,2:ncol(indica)])
indica <- subset(indica, select = -c(Hom1,Hom2,Hom3,Hom4,X1,GA,GA1,GA2,GA3,GA4,TW,TW1,TW2,TW3,TW4))
...
indica <- indica0[min(which(indica0$H34 != 9.999900e+04)):max(which(indica0$Hom != 9.999900e+04)),]
indica <- data.frame(indica[,2:ncol(indica)])
indica <- subset(indica, select = -c(X1,Hom1,Hom2,Hom3,Hom4,GA,GA1,GA2,GA3,GA4,TW,TW1,TW2,TW3,TW4))
...
indica <- indica0[min(which(indica0$H34 != 9.999900e+04)):max(which(indica0$Hom != 9.999900e+04)),]
indica <- data.frame(indica[,2:ncol(indica)])
indica <- subset(indica, select = -c(X1,Hom1,Hom2,Hom3,Hom4,GA,MOH,H3,GTH,BCs,GTG,MOR,EPU,MOU,TW,GA1,GA2,GA3,GA4,TW1,TW2,TW3,TW4))
...
indica <- subset(indica, select = -c(X1,Hom1,Hom2,Hom3,Hom4,X1,GA,MOH,H3,GTH,BCs,GTG,MOR,EPU,MOU,TW,
                                     GA1,MOH1,H31,GTH1,BCs1,GTG1,MOR1,EPU1,MOU1,TW1,GA2,GA3,GA4,TW2,TW3,TW4))
...
indica <- indica0[min(which(indica0$H34 != 9.999900e+04)):(max(which(indica0$Hom != 9.999900e+04))+1),]
...
indica <- indica0[min(which(indica0$H34 != 9.999900e+04)):(max(which(indica0$Hom != 9.999900e+04))+2),]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast[1]
...
indica <- indica0[min(which(indica0$H34 != 9.999900e+04)):(max(which(indica0$Hom != 9.999900e+04))+3),]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast[1]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast_v0[1]
...
indica <- indica0[min(which(indica0$H34 != 9.999900e+04)):(max(which(indica0$Hom != 9.999900e+04))+4),]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast[1]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast_v0[1]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast_v1[1]
...
for (j in 5:23){
indica <- indica0[min(which(indica0$H34 != 9.999900e+04)):(max(which(indica0$Hom != 9.999900e+04))+j),]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast[1]
indica$Hom[max(which(indica$Hom != 9.999900e+04))+1] <- lstm_forecast_v0[1]
for (k in 1:(j-2)){
