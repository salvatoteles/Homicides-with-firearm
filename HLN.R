...
df0 <- read.xlsx("Forecasts_OUT_back_tri.xlsx",sheetName = "h1")
...
df0 <- read.xlsx("Forecasts_OUT_back_tri.xlsx",sheetName = "h2")
...
df0 <- read.xlsx("Forecasts_OUT_back_tri.xlsx",sheetName = "h3")
...
########
#Nowcast
df0 <- read.xlsx("Forecasts_OUT_now_tri.xlsx",1)
...
df0 <- read.xlsx("Forecasts_OUT_now_tri.xlsx",2)
...
df0 <- read.xlsx("Forecasts_OUT_now_tri.xlsx",3)
...
df0 <- read.xlsx("Forecasts_OUT_now_tri.xlsx",4)
...
df0 <- read.xlsx("Forecasts_OUT_now_tri.xlsx",5)
...
df0 <- read.xlsx("Forecasts_OUT_now_tri.xlsx",6)
